...
#
# Script generated by Vivado on Tue Nov 05 10:42:14 EST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clk_wiz_50MHz.sh
...
#
# Usage        : clk_wiz_50MHz.sh
#                clk_wiz_50MHz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wiz_50MHz.sh [-reset_run]
#                clk_wiz_50MHz.sh [-reset_log]
#                clk_wiz_50MHz.sh [-help]
#
...
# script info
echo -e "clk_wiz_50MHz.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wiz_50MHz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_50MHz xil_defaultlib.clk_wiz_50MHz xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_wiz_50MHz -key {Behavioral:sim_1:Functional:clk_wiz_50MHz} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_wiz_50MHz.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_wiz_50MHz.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_wiz_50MHz.sh [-help]\n\
Usage: clk_wiz_50MHz.sh [-step]\n\
Usage: clk_wiz_50MHz.sh [-lib_map_path]\n\
Usage: clk_wiz_50MHz.sh [-reset_run]\n\
Usage: clk_wiz_50MHz.sh [-reset_log]\n\
Usage: clk_wiz_50MHz.sh [-keep_index]\n\
Usage: clk_wiz_50MHz.sh [-noclean_files]\n\n\
