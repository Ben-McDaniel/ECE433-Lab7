...
#
# Script generated by Vivado on Tue Oct 22 14:33:41 EDT 2024
...
#
# Usage        : Clock80MHz.sh
#                Clock80MHz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Clock80MHz.sh [-reset_run]
#                Clock80MHz.sh [-reset_log]
#                Clock80MHz.sh [-help]
#
...
#                script (type 'Clock80MHz.sh -help' for more information).
#
...
# script info
echo -e "Clock80MHz.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Clock80MHz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Clock80MHz xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Clock80MHz -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/beandog/433/ECE433-Lab7/Lab7.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Clock80MHz_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: Clock80MHz.sh [-step]\n\
Usage: Clock80MHz.sh [-lib_map_path]\n\
Usage: Clock80MHz.sh [-reset_run]\n\
Usage: Clock80MHz.sh [-reset_log]\n\
Usage: Clock80MHz.sh [-keep_index]\n\
